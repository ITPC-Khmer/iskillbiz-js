        ...
        <div class="d-flex justify-content-between align-items-start mb-3">
          <div class="flex-grow-1">
            ...
            <p class="text-muted small mb-0">
              Super_admin only — Define roles and assign permissions to control
              access levels
            </p>
          </div>
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              <tr v-for="r in roles" :key="r.id">
                ...
                <td>
                  <button class="btn btn-link btn-sm p-0" @click="select(r)">
                    Edit
                  </button>
                </td>
              </tr>
...
async function submit() {
  ...
  msg.value = "";
  try {
    const permissions = selectedPerms.value.length
      ? selectedPerms.value
      : undefined;
    if (form.id) {
